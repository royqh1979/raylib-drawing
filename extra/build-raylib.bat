...
set RAYLIB_FOLDER=%RDRAWING_FOLDER%\..\raylib
...
xcopy /Y /I "raylib\include" "%TARGET_FOLDER%\i686-w64-mingw32\include" 
copy /Y "raylib\libraylib.a" "%TARGET_FOLDER%\i686-w64-mingw32\lib" 
...
xcopy /Y /I "raylib\include" "%TARGET_FOLDER%\x86_64-w64-mingw32\include" 
copy /Y "raylib\libraylib.a" "%TARGET_FOLDER%\x86_64-w64-mingw32\lib" 
