...
cmake "%RDRAWING_FOLDER%" -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=Release
mingw32-make -j8
...
copy /Y "src\include" "%TARGET_FOLDER%\i686-w64-mingw32" 
copy /Y "src\librdrawing.a" "%TARGET_FOLDER%\i686-w64-mingw32\lib" 
copy /Y "src\librturtle.a" "%TARGET_FOLDER%\i686-w64-mingw32\lib" 
...
copy /Y "src\include" "%TARGET_FOLDER%\x86_64-w64-mingw32" 
copy /Y "src\librdrawing.a" "%TARGET_FOLDER%\x86_64-w64-mingw32\lib" 
copy /Y "src\librturtle.a" "%TARGET_FOLDER%\x86_64-w64-mingw32\lib" 
